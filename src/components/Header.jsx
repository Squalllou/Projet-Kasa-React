  ...
  return (
    <header className="header">
      ...
      <nav className="header__nav">
        ...
        <NavLink to="/a-propos" className={({ isActive }) => isActive ? 'header__link header__link--active' : 'header__link'}>A PROPOS</NavLink> {/** comme la class Link permet d'utiliser isactive qui va definir la classe du lien et donc savoir lequel est actif et sousligne */}
      </nav>
    </header>
  )
}
